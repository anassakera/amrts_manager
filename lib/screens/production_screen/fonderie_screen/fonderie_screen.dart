...
class _FonderieScreenState extends State<FonderieScreen> {
  ...
  void _handleDelete(Map<String, dynamic> fondry) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Voulez-vous vraiment supprimer ${fondry['ref_fondrie']} ?',
        ),
        actions: [
          TextButton(
          ...
          TextButton(
            onPressed: () {
              ...
              setState(() {
                _deletingItems.add(fondry['ref_fondrie']);
              });
                ...
                if (mounted) {
                  setState(() {
                    fondries.removeWhere(
                      (f) => f['ref_fondrie'] == fondry['ref_fondrie'],
                    );
                    _deletingItems.remove(fondry['ref_fondrie']);
                  });
                }
              });

              // اعرض الـ SnackBar مباشرة بعد إغلاق الـ Dialog
      ...
      body: displayedFondries.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return FonderieCard(
                  key: ValueKey(fondryId), // أضف key فريد
                  fondry: fondry,
